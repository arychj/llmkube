...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouterAlias) DeepCopyInto(out *RouterAlias) {
	*out = *in
	if in.Backends != nil {
		in, out := &in.Backends, &out.Backends
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouterAlias.
func (in *RouterAlias) DeepCopy() *RouterAlias {
	if in == nil {
		return nil
	}
	out := new(RouterAlias)
